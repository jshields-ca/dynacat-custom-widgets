...
[![ToDoist-API](https://img.shields.io/badge/ToDoist-API-v1-informational)](https://developer.todoist.com/api/v1/)
...
Paste the contents of [`todoist-dashboard.yml`](todoist-dashboard.yml) into a column's `widgets:` list in your Dynacat `config.yml`.
