...
### 3. Add the widget to your `dynacat.yml`

Copy the widget block from [`currency-exchange-rate.yml`](./currency-exchange-rate.yml) and paste into a `widgets:` list in your config:
  ...
  - title: Home
    columns:
      - size: small
        widgets:
          - type: custom-api
            title: 🍁 CAD Exchange Rates
            # ... (see currency-exchange-rate.yml for the full block)
```
